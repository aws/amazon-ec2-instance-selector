...
```
curl -Lo ec2-instance-selector https://github.com/aws/amazon-ec2-instance-selector/releases/download/v2.3.0/ec2-instance-selector-`uname | tr '[:upper:]' '[:lower:]'`-amd64 && chmod +x ec2-instance-selector
```
...
Global Flags:
  ...
  -o, --output string      Specify the output format (table, table-wide, one-line) (default "simple")
